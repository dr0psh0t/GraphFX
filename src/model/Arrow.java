...
public class Arrow extends Polygon
{
	...
	public Arrow(LineEdge curve, float t, Weight startPoint)
	{
		//super(new double[]{0.0, 11.0, -9.0, -9.0, 9.0, -9.0});
	...
	public Arrow(LineEdge curve, float t, double... arg0)
	{
		super(arg0);
		this.curve = curve;
		this.t = t;
	...
	{
		// ty lord!
		double angle = Math.atan2(curve.getEndY() - startPoint.getY(), curve.getEndX() - startPoint.getX()) * 180 / 3.14;
