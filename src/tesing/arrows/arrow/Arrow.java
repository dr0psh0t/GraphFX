...
public class Arrow extends Polygon
{
	...
	public Arrow(QuadCurve curve2, float t, double[] arg0)
	{
		super(arg0);
		this.curve = curve2;
		this.t = t;
    ...
    private Point2D eval(QuadCurve c, float t)
    {
        Point2D p=new Point2D(
        		...
        		Math.pow(1-t,3)*c.getStartX()+3*t*Math.pow(1-t,2)*c.getControlY()+3*(1-t)*t*t*c.getControlY()+Math.pow(t, 3)*c.getEndX(),
