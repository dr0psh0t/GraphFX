...
public class CubicCurveManipulatorWithArrows extends Application {
  ...
  @Override public void start(final Stage stage) throws Exception {
    ...
    Line controlLine1 = new BoundLine(curve.controlX1Property(), curve.controlY1Property(),
    		curve.startXProperty(), curve.startYProperty());
    Line controlLine2 = new BoundLine(curve.controlX2Property(), curve.controlY2Property(),
    ...
    arrows.add( new Arrow( curve, 0.95f, arrowShape));
